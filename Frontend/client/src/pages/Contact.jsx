                  ...
                  <>
                    ...
                    <div className="flex mb-8 border-b border-gray-200">
                      {[
                        ...
                        <button
                          key={tab.key}
                          className={`cursor-pointer px-6 py-3 font-medium transition-all duration-300 ${
                            activeTab === tab.key
                              ? " text-blue-700 border-b-2 border-gray-600"
                    ...
                    {activeTab === "contact" && (
                      ...
                      >
                        ...
                        <button
                          type="submit"
                          className="bg-blue-700 hover:opacity-90 px-6 py-3 rounded-lg font-medium flex items-center gap-2 transition-all duration-300 hover:shadow-lg text-white"
                        >
                          Send Message
